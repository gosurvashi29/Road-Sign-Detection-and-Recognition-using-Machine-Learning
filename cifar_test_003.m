...
if doTraining    
    ...
    load('fasterRCNNVehicleTrainingData.mat','cifar10Net')       
end
...
data = load('fasterRCNNVehicleTrainingData.mat', 'stopSignsAndCars');
...
%         example. Set this flag to true to train the detector.
    ...
    if doTraining
        ...
        load('fasterRCNNVehicleTrainingData.mat','rcnn')       
    end
    ...
    % Read test image
    testImage = imread('vipwarningsigns_yield_template.png');
